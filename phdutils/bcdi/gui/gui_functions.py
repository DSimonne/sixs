...
def preprocess_bcdi(
    ...
    detector, linearity_func, x_bragg, y_bragg, roi_detector, photon_threshold, photon_filter, background_file, hotpixels_file, flatfield_file, template_imagefile, nb_pixel_x, nb_pixel_y,
