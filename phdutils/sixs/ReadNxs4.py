       ...
       ###################### Reading SBS ####################################
        ...
        try:
            self._integration_time = f.SIXS._f_get_child(
                'i14-c-c00-ex-config-publisher').integration_time[0]
                ...
                for el in dets:
                    if el == 'xpad70':
                        self._roi_limits_xpad70 = f.SIXS._f_get_child(
                            'i14-c-c00-ex-config-xpads70').roi_limits[:][:]
                        ...
                        roi_names_cell = f.SIXS._f_get_child(
                            'i14-c-c00-ex-config-xpads70').roi_name.read()
                    ...
                    if el == 'xpad140':
                        # print('xpad140')
                        self._roi_limits_xpad140 = f.SIXS._f_get_child(
                            'i14-c-c00-ex-config-xpads140').roi_limits[:][:]
                        self.attlist.append('_roi_limits_xpad140')
                        ...
                        roi_names_cell = f.SIXS._f_get_child(
                            'i14-c-c00-ex-config-xpads140').roi_name.read()
                        self._roi_names_xpad140 = roi_names_cell.tolist().decode().split('\n')
                        self.attlist.append('_roi_names_xpad140')
                    if el == 'merlin':
                        # print('xpad140')
                        self._roi_limits_merlin = f.SIXS._f_get_child(
                            'i14-c-c00-ex-config-merlin').roi_limits[:][:]
                        ...
                        roi_names_cell = f.SIXS._f_get_child(
                            'i14-c-c00-ex-config-merlin').roi_name.read()
                ...
                for el in list2d:
                    try:
                        ...
                        for pos, roi in enumerate(self.__getattribute__('_roi_limits_' + el), start=0):
                            roiname = self.__getattribute__(
                                '_roi_names_' + el)[pos] + '_'+el+'_new'
                            self.calcROI(
